...
function AdminDashboard() {
  ...
  return (
    <div className="flex h-screen">
      <div
        className={`sidebar w-64 bg-purple-700 text-white ${
          open ? 'block' : 'hidden'
        }`}
      >
        <div className="text-purple-200 h-14 px-4 py-5">WELCOME, ADMIN</div>
        <div className="h-screen">
          <div className="text-sm">
            <a
              href="#"
              className="block py-3 px-4 border-b-2 border-purple-800 hover:bg-white hover:text-purple-800"
            >
              Dashboard
            </a>
            <a
      ...
      <div className="w-full">
        <div className="sticky top-0 bg-purple-600 h-14 px-10 py-4 border-b-4 border-purple-900 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-8 text-gray-400 text-base">
            ...
            <i className="fas fa-cog fa-2x text-white cursor-pointer animate-spin hover:text-green-500"></i>
          </div>
        </div>
