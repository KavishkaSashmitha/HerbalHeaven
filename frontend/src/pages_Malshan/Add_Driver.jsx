...
export default class Add_Driver extends Component {
  ...
  validateLicence = () => {
    ...
    const licenceRegex = /^B\d{7}$/;
    if (!licence) {
      return "Licence is required";
    }
    if (!licenceRegex.test(licence)) {
      return "Invalid driving licence number. Please enter a valid Sri Lankan driving licence number starting with 'B' followed by 7 digits.";
    }
    return "";
  };
                      ...
                      <form class="flex flex-col gap-4 mt-12">
                        ...
                        <div>
                          ...
                          <div class="relative h-10 w-full min-w-[200px]">
                            ...
                            />
                            {errors.licence && errors.licence.length > 0 &&(
                              <p className="ml-1 text-sm text-red-500 sans">
                                {errors.licence}
                              </p>
                            )}
