...
export default class Add_Driver extends Component {
  ...
  onSubmit = (e) => {
    ...
    const { d_name, d_mobile, dob, gender, vehicle_type, vehicle_No } =
      this.state;
  ...
  render() {
    ...
    return (
      <div
        className="max-w-screen-md mx-auto mt-4"
      ...
      >
        ...
        <form className="space-y-4" onSubmit={this.onSubmit}>
          ...
          <div className="space-y-4">
            <label className="block text-sm font-semibold" htmlFor="d_mobile">
              Mobile No.
            </label>
            <input
              type="text"
          ...
          <div className="space-y-4">
            ...
            {!isAgeValid && (
              <p className="text-xs text-red-500">
                Driver's age must be between 20 and 60 years.
              </p>
            )}
          </div>
          ...
          <div className="space-y-4">
            <label className="block text-sm font-semibold" htmlFor="vehicle_No">
              Vehicle Number
            </label>
            <input
              type="text"
              id="vehicle_No"
              className={`border border-gray-300 rounded-md px-3 py-2 w-full focus:outline-none ${
                !isVehicleNoValid ? 'border-red-500' : ''
              }`}
              name="vehicle_No"
