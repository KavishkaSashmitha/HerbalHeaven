  ...
  render() {
    return (
      <div className="center" style={{ marginLeft: '25%' }}>
        <div className="row">
          <h1 style={{ fontSize: '30px', fontWeight: '650' }}>
            All Drivers List
          </h1>
          <div
            className="mt-2 mb-2 lg:col-span-3 lg:ml-auto"
            style={{ marginLeft: '75%', height: '40px' }}
          >
            <input
            ...
            {this.state.transports.map((transport, index) => (
              <tr key={index}>
                ...
                <td className="px-4 py-2 border-0">
                  <a
                    href={`http://localhost:8070/api/transports/transport/${transport._id}`}
                ...
                <td className="px-4 py-2 border-0">
                  <a
                    className="relative inline-block btn btn-warning"
                    style={{ color: '#33542d' }}
                  ...
                  &nbsp; &nbsp;
                  <button
                    className="relative inline-block btn btn-danger"
                    style={{ color: 'red' }}
                    onClick={() => this.onDelete(transport._id)}
                  >
